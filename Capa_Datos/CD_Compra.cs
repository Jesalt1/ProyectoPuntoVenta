...
namespace Capa_Datos
{
    public class CD_Compra
    {
                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            obj = new Compra()
                            {
                                ...
                                oProveedor = new Proveedores() { Documento = dr["Documento"].ToString(), RazonSocial = dr["RazonSocial"].ToString() },
        ...
        public List<Detalle_Compra> ObtenerDetalleCompra(int idcompra)
        {
            ...
            try
            {
                using (SqlConnection conexion = new SqlConnection(ConexionBD.cadena))
                {
                    conexion.Open();
                    StringBuilder query = new StringBuilder();
