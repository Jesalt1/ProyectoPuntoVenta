...
namespace SistemaPuntoVenta.Ventas
{
    public partial class frmRegistrarVentas : Form
    {
        ...
        int idProveedorTmp;
        int idProductoTmp;
        public frmRegistrarVentas(Usuario usuario = null)
        {
            InitializeComponent();
            _usuario = usuario;
        }
        ...
        {
            //se utiliza las librerias de Modals para que se abra el form median un showdialog para un mejor manejo de los procesos
            using (var modal = new mdCliente())
            {
                var result = modal.ShowDialog();

                //si se acepta un cliente en el show dialog se cargan sus datos en los text box del group box cliente
        ...
        {
            //se utiliza la referencia para llamar al form dentro de un showdialog para un mayor manejo del proceso de busqueda de producto
        ...
        private void btnagregarproducto_Click(object sender, EventArgs e)
        {
            ...
            if (!producto_existe)
            {
                ...
                bool respuesta = new VentasNeg().RestarStock(
                    idProductoTmp,
        ...
        private void btncrearventa_Click(object sender, EventArgs e)
        {
            ...
            int idcorrelativo = new VentasNeg().ObtenerCorrelativo();
            ...
            bool respuesta = new VentasNeg().Registrar(oVenta, detalle_venta, out mensaje);
        ...
        private void dgvdata_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvdata.Columns[e.ColumnIndex].Name == "btneliminar")
            {
                ...
                if (index >= 0)
                {
                    bool respuesta = new VentasNeg().SumarStock(
